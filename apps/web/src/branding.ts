...
const normalizedInjectedBaseName = injectedDesktopAppBranding?.baseName?.trim();
const resolvedBaseName =
  normalizedInjectedBaseName && normalizedInjectedBaseName !== "T3 Code"
    ? normalizedInjectedBaseName
    : "NorthStar Code";
...
export const APP_BASE_NAME = resolvedBaseName;
