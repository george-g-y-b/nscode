// This file mostly exists because we want dev mode to say "NorthStar Code (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "NorthStar Code (Dev)" : "NorthStar Code (Alpha)";
